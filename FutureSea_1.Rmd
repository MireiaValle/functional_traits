...
```{r}
hs <- read_csv ('/home/valle/github_annex/Aquamaps/d2018/hcaf_species_native_ver0816c.csv', col_names = TRUE, col_types = 'ccddiidd', guess_max = 100000)
...
sum(is.na(hs$LOICZID))
```
##Subset hs table, we are interested in SPECIESID and CsquareCode columns only
```{r}
hs_subset <- subset(hs, select=c("SPECIESID", "CsquareCode", "LOICZID","probability"))
```
