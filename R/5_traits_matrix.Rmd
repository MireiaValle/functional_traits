...
Hadopelagic <int>
FeedingType <fct>
DietTroph <dbl>, DietSeTroph <dbl>, FoodTroph <dbl>,
#   FoodSeTroph <dbl>, FoodRemark <fct>, AddRems <fct>, Benthic <int>, Sessile <int>, Mobile <int>, Demersal <int>,
#   Endofauna <int>, Pelagic <int>, fecuntype <fct>, fecun_min <dbl>, fecun_max <dbl>, OperculumPresent <int>,
#   BodyShapeI <fct>, SexualAttributes <fct>, SexMorphology <fct>, TypeofEyes <fct>, PosofMouth <fct>,
#   TypeofMouth <fct>, CaudalFinI <fct>, CShape <fct>, PelvicsAttributes <fct>, IUCN_Code <fct>, Protected <int>,
#   EnvTemp <fct>, Resilience <fct>, ResilienceRemark <fct>, AdultType <fct>, AdultMode <fct>, am_sid <fct>,
#   genus <fct>, species <fct>, kingdom <fct>, phylum <fct>, class <fct>, order <fct>, family <fct>, Loo <dbl>, K <dbl>,
#   Winfinity <dbl>, tmax <dbl>, tm <dbl>, M <dbl>, Lm <dbl>, temperature <dbl>
